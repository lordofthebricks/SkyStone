...
@Autonomous(name="Gimli scrimage auto ", group="Gimli")
public class bridgeGimli extends LinearOpMode {

    static final double COUNTS_PER_MOTOR_REV = 356.3;    // eg: DC Motor Encoder
    static final double DRIVE_GEAR_REDUCTION = 1.0;     // This is < 1.0 if geared UPPushbuouuuut'sPusPusPushbot'shbot'shbot's
    ...
    Gimli_test_hardware robot = new Gimli_test_hardware();   // Use a Push hardware
